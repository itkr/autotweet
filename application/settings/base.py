# Django settings for autotweet project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
     ('Shota Itakura', 'itkrst@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'twitter',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'fb-nfbpnf+50h)w-mx^v%-b+1pn@y0ko6+8e5j4yi6a56#y=%d'
